...
then
	...
	echo -n "commenting out FGEAL_ALLEGRO4_LOADPNG_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_LOADPNG_INSTALLED,//#define FGEAL_ALLEGRO4_LOADPNG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then
	...
	echo -n "commenting out FGEAL_ALLEGRO4_JPGALLEG_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_JPGALLEG_INSTALLED,//#define FGEAL_ALLEGRO4_JPGALLEG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then
	...
	echo -n "commenting out FGEAL_ALLEGRO4_LOGG_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_LOGG_INSTALLED,//#define FGEAL_ALLEGRO4_LOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
	echo -n "commenting out FGEAL_ALLEGRO4_ALOGG_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,//#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then
	echo -n "Commenting out FGEAL_ALLEGRO4_ALOGG_INSTALLED in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,//#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
	echo -n "Uncommenting FGEAL_ALLEGRO4_LOGG_INSTALLED in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,//#define FGEAL_ALLEGRO4_LOGG_INSTALLED,#define FGEAL_ALLEGRO4_LOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then
	echo -n "Commenting out FGEAL_ALLEGRO4_LOGG_INSTALLED in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_LOGG_INSTALLED,//#define FGEAL_ALLEGRO4_LOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
	echo -n "Uncommenting FGEAL_ALLEGRO4_ALOGG_INSTALLED in src_libs/fgeal/adapters/allegro4/implementation.hpp ..."
	sed -i "s,//#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,#define FGEAL_ALLEGRO4_ALOGG_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
	echo -n "Replace -llogg with -lalogg...";
	sed -i "s,-llogg,-lalogg,g" objects.mk;
...
then 
	...
	echo -n "commenting out FGEAL_ALLEGRO4_ALLEGTTF_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_ALLEGTTF_INSTALLED,//#define FGEAL_ALLEGRO4_ALLEGTTF_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then 
	...
	echo -n "commenting out FGEAL_ALLEGRO4_ALGIF_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ...";
	sed -i "s,#define FGEAL_ALLEGRO4_ALGIF_INSTALLED,//#define FGEAL_ALLEGRO4_ALGIF_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
...
then
	...
	echo -n "commenting out FGEAL_ALLEGRO4_ALLEGROMP3_INSTALLED flag in src_libs/fgeal/adapters/allegro4/implementation.hpp ..."; 
	sed -i "s,#define FGEAL_ALLEGRO4_ALLEGROMP3_INSTALLED,//#define FGEAL_ALLEGRO4_ALLEGROMP3_INSTALLED,g" ../src_libs/fgeal/adapters/allegro4/implementation.hpp;
	echo "done";
