...
then
	echo -n "Uncommenting FGEAL_SFML1_6_ENABLE_COMPATIBILITY_PRE_1_6 macro in adapters/sfml/implementation.hpp ...";
	sed -i "s,//#define FGEAL_SFML1_6_ENABLE_COMPATIBILITY_PRE_1_6,#define FGEAL_SFML1_6_ENABLE_COMPATIBILITY_PRE_1_6,g" ../src_libs/fgeal/adapters/sfml/implementation.hpp;
	echo "done";
fi
