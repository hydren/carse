...
namespace GameEngine
{
	...
	class Display
	{
		 ...
		 * */
		Display(int width=800, int height=600, const string& title="", Image* icon=NULL);
	...
	struct Color
	{
		...
		// further extra colors
		BEIGE, LIME, SCARLET, MINT, AZURE, TURQUOISE, VIOLET,
		SALMON, BRONZE, WINE, INDIGO, CELESTE, FLAME, GOLD,
		CREAM, CARAMEL, RUBY, JADE, CERULEAN, AQUA, FUSCHIA
		;
	};
